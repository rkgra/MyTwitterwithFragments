...
public class MentionsTimelineFragment extends TweetsListFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        populateMentionsTimeline(TwitterClient.DEFAULT_MAX_ID, true);
    ...
    protected void customLoadMoreDataFromApi(long maxId) {
        ...
        populateMentionsTimeline(getMax_id(), false);
    ...
    private void populateMentionsTimeline(String max_id, final Boolean clearResults) {

        Log.d("DEBUG", "populateMentionsTimeline-----max_id-->" + max_id + "clearResults>" + clearResults);
        ...
        client.getMentionsTimeline(max_id, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray json) {
                ...
                Log.d("DEBUG", "populateMentionsTimeline onSuccess----->" + json.toString());
                Log.d("DEBUG", "populateMentionsTimeline onSuccess-statusCode---->" + statusCode);
